...
namespace Myutilootor
{
    ...
    class myDebug
    {
        internal static string[] args = { "zLootSnobV4~0.utl", "-keep-inactive" }; //{ "utl_mut/zLootSnobV4.utl" };
    }
#endif
    internal static class CmdLnArgs
    {
        internal const string version = "myutilootor, v.0.1.1     GPLv3 Copyright (C) 2021     Created by J. Edwards";
    ...
    class Myutilootor
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length > 0)
            {
                ...
                {
                    StreamWriter fOut = new(CmdLnArgs.newFileName); // System.IO.StreamWriter
                    fOut.WriteLine(TextForUsers.header);
                    fOut.Close();
                    Console.Write($"\n\tOutput file: {CmdLnArgs.newFileName}\n");
                    Environment.Exit(0);
                }
                if (args[0].CompareTo("-help") == 0)
                {
                    StreamWriter fOut = new(CmdLnArgs.refFileName); // System.IO.StreamWriter
                    fOut.WriteLine(TextForUsers.reference);
                    fOut.Close();
                    Console.Write($"\n\tOutput file: {CmdLnArgs.refFileName}\n");
        ...
        //static void Main(string[] args)
        //{
        //Console.WriteLine(String.Join(" ", E.Salvage.Keys));

        //Console.WriteLine(TextForUsers.V_SalvageTable);
        //    Console.WriteLine();
        //    Console.WriteLine(TextForUsers.A_ActsOnTable);
        //    //Console.WriteLine(TextForUsers.D_ActsOnTable);
        //    //Console.WriteLine();
        //    //Console.WriteLine(TextForUsers.L_ActsOnTable);
        //    //Console.WriteLine();
        //    //Console.WriteLine(TextForUsers.M_ActsOnTable);
        //    //Console.WriteLine();
        //    //Console.WriteLine(TextForUsers.C_ActsOnTable);
        //    //Console.WriteLine();
        //    //Console.WriteLine(TextForUsers.S_ActsOnTable);
        //    //Console.WriteLine();
        //    //Console.WriteLine(String.Join("|",Enum.GetNames(typeof(E.Requirement)).Where(nm => nm!="Disabled")));
        //    //Console.WriteLine(String.Join(" ", E.ArmorType.Keys));
        //}
    }
}